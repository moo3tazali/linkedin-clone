...
const SignUp = () => {
  const { isPending, mutateAsync: signUpMutate, error } = useSignUp();
  const {
    register,
    handleSubmit,
    formState: { errors },
      ...
      <div className={AuthFormClasses.box}>
        ...
        <div className='bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 max-w-md'>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {error && (
              <div className='text-red-500 flex items-center justify-center mb-2 tracking-tighter font-semibold text-sm'>
